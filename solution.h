...
public:
  ...
  matrix fit_fun(matrix (*)(matrix, matrix, matrix), matrix = NAN,
                 matrix = NAN); // throw (string);
  matrix grad(matrix (*)(matrix, matrix, matrix), matrix = NAN,
              matrix = NAN); // throw (string);
  matrix hess(matrix (*)(matrix, matrix, matrix), matrix = NAN,
              matrix = NAN); // throw (string);
};
